...
|VQ-BeT: Behavior generation with latent actions|ICML2024||在实验部分，为什么Goal-Conditional behavior generation效果还要更差一些呢？反而是Unconditional behavior generation的效果在 5 of 6 tasks表现的都很好。|
