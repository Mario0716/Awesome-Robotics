...
|Efficient Reductions for Imitation Learning|arxiv|为了简化模仿学习任务，文章提出了几种简化方法，<br>将学习任务拆分成两部分，第一部分在低维度空间内进行预训练，智能体先快速学习到一些基础的行为模式；第二部分是在高维度状态和动作空间进行地优化，以低维空间学习到的策略为起始点，结合策略优化算法和奖励函数正则化，将低维策略向高维度迁移，逐步扩展高维度任务的难度，减少学习所需的专家演示数量，让IL学习之前任务已经学到的知识||
